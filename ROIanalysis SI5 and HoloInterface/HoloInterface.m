function varargout = HoloInterface(varargin)
% HOLOINTERFACE MATLAB code for HoloInterface.fig
%      HOLOINTERFACE, by itself, creates a new HOLOINTERFACE or raises the existing
%      singleton*.
%
%      H = HOLOINTERFACE returns the handle to a new HOLOINTERFACE or the handle to
%      the existing singleton*.
%
%      HOLOINTERFACE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HOLOINTERFACE.M with the given input arguments.
%
%      HOLOINTERFACE('Property','Value',...) creates a new HOLOINTERFACE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before HoloInterface_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to HoloInterface_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help HoloInterface

% Last Modified by GUIDE v2.5 03-Sep-2015 13:37:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @HoloInterface_OpeningFcn, ...
                   'gui_OutputFcn',  @HoloInterface_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before HoloInterface is made visible.
function HoloInterface_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to HoloInterface (see VARARGIN)
locations = SatsumaRigFile();
% Choose default command line output for HoloInterface
...
handles.save=0;
handles.excludePixels = 10;
handles.cycleSequence = 0;
handles.saveDir = locations.ROIanalysisDefaultPath;
handles.excludeCenter = 0;
handles.iii = 1;
handles.makeSeq=0;
handles.nDLS = 1;
handles.channel='green';
% Update handles structure
handles.ROIdata=load([locations.HoloRequest 'ROIdata.mat']);
guidata(hObject, handles);

% UIWAIT makes HoloInterface wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = HoloInterface_OutputFcn(hObject, eventdata, handles) 
...
if isdir(handles.saveDir) == 0
    errordlg('put in a real directory to save in, asshole')
    warning = 1;
end;
...
% 
   % errordlg('SpecialGrid = 1 (line 635)')
    holoRequest.specialGrid = 0;  % if 1 will only apply grid to ROI1
    ...
    holoRequest.nDLS = handles.nDLS;
    holoRequest.channel = handles.channel;
...
% --- Executes during object creation, after setting all properties.
function saveDIR_et_CreateFcn(hObject, eventdata, handles)
% hObject    handle to saveDIR_et (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function excludeROIs_CB_Callback(hObject, eventdata, handles)
...
% --- Executes on button press in excludeCeneter_CB.
function excludeCeneter_CB_Callback(hObject, eventdata, handles)
% hObject    handle to excludeCeneter_CB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (get(hObject,'Value') == get(hObject,'Max'))
	handles.excludeCenter=1;
else
	handles.excludeCenter=0;
end
...
% Hint: get(hObject,'Value') returns toggle state of excludeCeneter_CB



function excludePixels_ET_Callback(hObject, eventdata, handles)
% hObject    handle to excludePixels_ET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

handles.excludePixels = str2double(get(hObject,'String'));
guidata(hObject, handles);
% Hints: get(hObject,'String') returns contents of excludePixels_ET as text
%        str2double(get(hObject,'String')) returns contents of excludePixels_ET as a double


% --- Executes during object creation, after setting all properties.
function excludePixels_ET_CreateFcn(hObject, eventdata, handles)
% hObject    handle to excludePixels_ET (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function nDLS_Callback(hObject, eventdata, handles)
% hObject    handle to nDLS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
  handles.nDLS = str2double(get(hObject,'String'));
% Hints: get(hObject,'String') returns contents of nDLS as text
%        str2double(get(hObject,'String')) returns contents of nDLS as a double
guidata(hObject,handles);

% --- Executes during object creation, after setting all properties.
function nDLS_CreateFcn(hObject, eventdata, handles)
% hObject    handle to nDLS (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes when selected object is changed in Channel.
function Channel_SelectionChangedFcn(hObject, eventdata, handles)
...
% hObject    handle to the selected object in Channel 
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
