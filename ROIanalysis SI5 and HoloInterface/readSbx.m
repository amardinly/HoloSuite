...
switch LoadType
    ...
    case {'Direct', 'direct'}
        ...
        % ADD: Check memory availability and split up large reads if
        % loading all channels of lots of frames is too much (assuming
        % reading in specific channels)
        ...
        if(info.fid ~= -1)
            ...
            % Flip colormap and reorder dimensions
            Images = intmax('uint16') - permute(Images,[3 2 5 1 4]); % flip colormap and reorder (original [1,3,2,4] => rotate images) 
