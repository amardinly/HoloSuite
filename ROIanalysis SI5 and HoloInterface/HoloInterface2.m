function varargout = HoloInterface2(varargin)
% HOLOINTERFACE2 MATLAB code for HoloInterface2.fig
%      HOLOINTERFACE2, by itself, creates a new HOLOINTERFACE2 or raises the existing
%      singleton*.
%
%      H = HOLOINTERFACE2 returns the handle to a new HOLOINTERFACE2 or the handle to
%      the existing singleton*.
%
%      HOLOINTERFACE2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HOLOINTERFACE2.M with the given input arguments.
%
%      HOLOINTERFACE2('Property','Value',...) creates a new HOLOINTERFACE2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before HoloInterface2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to HoloInterface2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help HoloInterface2

% Last Modified by GUIDE v2.5 24-Aug-2016 11:09:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @HoloInterface2_OpeningFcn, ...
    'gui_OutputFcn',  @HoloInterface2_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before HoloInterface2 is made visible.
function HoloInterface2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to HoloInterface2 (see VARARGIN)
locations = SatsumaRigFile();
% Choose default command line output for HoloInterface2
...
% UIWAIT makes HoloInterface2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = HoloInterface2_OutputFcn(hObject, eventdata, handles)
